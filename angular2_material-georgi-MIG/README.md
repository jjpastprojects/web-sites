...
> If you're looking for something easier to get started with then see the offical angular2-seed [angular/angular2-seed](https://github.com/angular/angular2-seed)  
