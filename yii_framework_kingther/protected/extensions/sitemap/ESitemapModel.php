...
class ESitemapModel extends CModel {
    ...
    public function rules() {
        return array(
            array('frequency,priority,route,baseModel,scopeName,permalink', 'required'),
    ...
    public function attributeNames() {
        return array('frequency', 'priority', 'route', 'params', 'baseModel', 'scopeName', 'permalink');
    }
    ...
    public function getPathFormat() {
        if ($this->_pathFormat === null) {
            if (empty($this->permalink)) {
                ...
                $this->_pathFormat = Yii::app()->createAbsoluteUrl('/' . $this->permalink);
            }
        }
