;(function($){
	$(document).ready(function(){
		...
		$('input[disabled]').parent().find('div').click(function(){
               alert('You have not checked your A/B Split Name, please head back to the top and do so.');
        });
	...
	function checkcampname(){
		...
		jQuery.post('index.php?section=ajax&action=ajax&do=checkcampname', data, function(response) {
