	            ...
	            <div class="form">
	                <div>
	                	<form id="removeme">
	                    	...
	                    	<input type="submit" value="<?php echo $fields['submit_button'] ?>" id="<?php echo $lightbox_submit_id?>"  src="<?php echo $theme_url?>/images/trans.png" class="<?php echo $button_color?>-button" />
