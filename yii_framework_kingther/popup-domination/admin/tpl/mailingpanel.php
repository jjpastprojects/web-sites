...
<script type="text/javascript" src="../javascript/mailing.js"></script>
...
<div class="wrap with-sidebar" id="popup_domination">
      ...
      <div id="popup_domination_container" class="has-left-sidebar">
      		<div id="popup_domination_tabs" class="campaign-details">
				<div class="campaign-name-box">
					...
					<input id="landingpage" name="landingpagecheck" type="checkbox" <?php if(!empty($redirecturl)){ echo 'checked="checked"';}else{echo '';} ?>/>
					<div class="clear"></div>
				...
				<div class="campaign-description">
					...
					<input id="landingurl" type="text" name="landingurldata" <?php if(!empty($redirecturl)){ echo '';}else{ echo 'disabled="disabled"';} ?> value="<?php if(!empty($redirecturl)){ echo $redirecturl;}else{echo '';} ?>" />
					<p class="microcopy">e.g. http://www.yourwebsite.com/thank-you.html</p>
				</div>
				<div class="clear"></div>
			</div>
            <div class="show_mailing">
               <a class="show_mail_link" href="#showmail">Show Mailing Providers</a>
            </div>
      		<div class="tab-menu main-menu" id="popup_domination_tabs">
            ...
            <div class="show_main_menu">
               <a class="show_mm_link" href="#showmain">Show Main Menu</a>
            </div>
            <div id="popup_domination_tabs" class="tab-menu mailing-comps">
				...
				<div class="mainbox" id="popup_domination_tab_aweber">
						<div class="inside twodivs">
							<div class="popdom_contentbox the_help_box">
								...
								<p><a href="#clear" class="button aweber_cookieclear">Clear my Aweber cookies</a> <img class="waiting" style="display:none;" src="<?php echo $this->plugin_url; ?>admin/css/img/ajax-loader.gif" alt="" /></p>
								<p><strong>NOTE:</strong> You <strong>MUST</strong> enter a <strong>re-direct url</strong>in the blue box area above if you plan to use Aweber API.</strong></p>
								</div>
								<div class="clear"></div>
							</div>
                    			...
                    			<div class="provider_divs">
                    				...
                    				<div class="aw">
		                    			...
		                    			<?php if(!isset($_COOKIE['aw_getlists']) && $_COOKIE['aw_getlists'] != 'Y'): ?>
                    						<a href="<?php  echo $this->plugin_url."inc/aweber.php?path=".$this->plugin_path.'&url='.$this->plugin_url.'admin/index.php?section=mailinglist#aweber';  ?>" alt='aw_apikey' class="connect-to getlist"><span>Connect to Aweber</span></a>
                    					<?php else: ?>
                ...
                <div class="mainbox" id="popup_domination_tab_icontact">
					<div class="inside twodivs">
						<div class="popdom_contentbox the_help_box">
							<h3 class="help">Help</h3>
							<div class="popdom_contentbox_inside">
								<p>Once Logged into your account, using your browser, navigate to: https://app.icontact.com/icp/core/registerapp</p>
								...
								<img src="<?php echo $this->plugin_url;?>admin/css/img/apiconnect.jpg" alt="" />
						...
						<h3>Please Fill in the Following Details:</h3>
            				<div class="ic">
            					...
            					<span class="example">iContact Application API Key</span>
            					<input type="text" name="apikey" alt='ic' value="<?php echo (isset($apidata['apikey']) && $apidata['apikey']) ? $apidata['apikey']: 'Your App-ID'; ?>" id="ic_apikey" />
					...
					<div class="inside twodivs">
						<div class="popdom_contentbox the_help_box">
							...
							<div class="popdom_contentbox_inside">
								...
								<img src="<?php echo $this->plugin_url;?>admin/css/img/apikey.jpg" alt="" />
								...
								<img src="<?php echo $this->plugin_url;?>admin/css/img/clientid.jpg" alt="" />
					...
					<div class="inside twodivs">
						<div class="popdom_contentbox the_help_box">
							...
							<div class="popdom_contentbox_inside">
								...
								<img src="<?php echo $this->plugin_url;?>admin/css/img/grkeys.png" alt="" />
							</div>
							<div class="clear"></div>
						</div>
						<div class="popdom-inner-sidebar">
						<h3>Please Fill in the Following Details:</h3>
            				...
            				<span class="example">GetResponse API Key</span>
            					<input type="text" name="gr_apikey" alt='gr' value="<?php if(!empty($apidata)){if($apidata['provider'] == 'mc'){ echo $apidata['apikey'];}else{ echo 'Enter Your Api key';}}else{ echo 'Enter Your Api key';} ?>" id="gr_apikey" />
            					<h3>Please Select a Mailing List:</h3>
					...
					<div class="inside twodivs">
						<div class="popdom_contentbox the_help_box">
							...
							<div class="popdom_contentbox_inside">
								...
								<img src="<?php echo $this->plugin_url;?>admin/css/img/keys.jpg" width="450" height="99" alt="" />
							</div>
							<div class="clear"></div>
						</div>
						<div class="popdom-inner-sidebar">
                ...
                <div class="mainbox" id="popup_domination_tab_email">
					<div class="inside twodivs">
						<div class="popdom_contentbox the_help_box">
							...
							<div class="popdom_contentbox_inside">
								...
								<p><strong>NOTE:</strong> You <strong>MUST</strong> enter a <strong>re-direct url</strong> in the blue box area above if you plan to use the Email Optins.</strong></p>
							</div>
							<div class="clear"></div>
						</div>
						<div class="popdom-inner-sidebar">
                 ...
                 <div class="mainbox" id="popup_domination_tab_htmlform">
					<div class="inside twodivs">
						<div class="popdom-inner-sidebar">  
                			<div class="other">
                				<form action="<?php echo "http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']; ?>&action=save<?php if(isset($apidata['provider']) && !empty($apidata['provider'])){ echo '#'.$apidata['provider'];}else{if(!empty($form) && isset($form)){echo '#htmlform';} } ?>" method="post">
                					<h3>Please Fill in the Following Details:</h3>
			                        <div class="col">
			                            <p class="msg">Enter your html opt-in code below and we'll hook up your form to the template:</p>
			                            <p><textarea cols="60" rows="10" id="popup_domination_formhtml" name="popup_domination[formhtml]"><?php echo $form; ?></textarea></p>
										...
										echo (isset($disable_name) && $disable_name=='Y')?' checked="checked"':''; ?> /> <label for="popup_domination_disable_name">Disable name box?</label></p>
			                            ...
			                            <p><textarea style="display:none" name="popup_domination[hidden_fields]" class="hidden_fields"><?php if(isset($hidden) && !empty($hidden)){ echo $hidden;} ?></textarea></p>
			                        ...
			                        <div class="clear"></div>
			                        <!--<input type="submit" name="customformsubmit" value="Save" />-->
									<input class="savecamp form-save-btn" type="submit" name="customformsubmit" value="Save Changes" />	
			                    </form>
			                </div>
		                   	<div class="clear"></div>
   						</div>	
                 ...
                 <div class="mainbox" id="popup_domination_tab_api">
					<div class="inside twodivs">
						<div class="popdom-inner-sidebar">                 
                 			<form id="form" name="apidata" id="apiformdata" action="<?php echo "http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']; ?>&action=save" method="post">
                 				<div class="mailingfeedback"></div>
                 				<p class="disabletext">Disable the Name Input?</p>
                 				<input type="checkbox" name="disablename" class="disablename" <?php if(isset($apidata['disablename']) && $apidata['disablename'] != ''){ echo 'checked = "checked"';}else{echo 'style="left:1px;"';} ?> />
                 				<div class="clear"></div>
                				<input type="hidden" name="listid" class="listid" value="<?php if(!empty($apidata)){ echo $apidata['listid'];}else{echo '';} ?>"/>
                				...
                				<span class="example custom1" style="<?php if(!isset($apidata['custom1']) && empty($apidata['custom1'])){ echo 'display:none;';}else{ echo 'display:block;';} ?>">What is Your 1st Custom Field Name? (Need Help? <a target="_blank"; href="http://popdom.desk.com/customer/portal/articles/367583-extra-custom-fields">Click Here</a>)</span>
                				<input type="text" style="<?php if(!isset($apidata['custom1']) && empty($apidata['custom1'])){ echo 'display:none;';}else{ echo 'display:block;';} ?>" name="custom1" class="custom1" value="<?php if(!empty($apidata)){ echo $apidata['custom1'];}else{echo '';} ?>"/>
                				<span class="example custom2" style="<?php if(!isset($apidata['custom2']) && empty($apidata['custom2'])){ echo 'display:none;';}else{ echo 'display:block;';} ?>">What is Your 2nd Custom Field Name? (Need Help? <a target="_blank"; href="http://popdom.desk.com/customer/portal/articles/367583-extra-custom-fields">Click Here</a>)</span>
                				<input type="text" style="<?php if(!isset($apidata['custom2']) && empty($apidata['custom2'])){ echo 'display:none;';}else{ echo 'display:block;';} ?>" name="custom2" class="custom2" value="<?php if(!empty($apidata)){ echo $apidata['custom2'];}else{echo '';} ?>"/>
                				...
                				<div class="current-connect">
	                				...
	                				<?php 
	                					if($apidata['provider'] == 'mc'){
	                						$logo = '<img src="'.$this->plugin_url.'admin/css/img/mailchimp.png" />';
	                					}else if($apidata['provider'] == 'aw'){
	                						$logo = '<img src="'.$this->plugin_url.'admin/css/img/aweber.png" style="margin-left:-13px;" />';
	                					}else if($apidata['provider'] == 'ic'){
	                						$logo = '<img src="'.$this->plugin_url.'admin/css/img/icontact.png" />';
	                					}else if($apidata['provider'] == 'cc'){
	                						$logo = '<img src="'.$this->plugin_url.'admin/css/img/constant.png" />';
	                					}else if($apidata['provider'] == 'cm'){
	                						$logo = '<img src="'.$this->plugin_url.'admin/css/img/campaign.png" />';
	                					}else if($apidata['provider'] == 'gr'){
	                						$logo = '<img src="'.$this->plugin_url.'admin/css/img/response.png" />';
                				...
                				<?php endif; ?>
                				<!--<input name="submit" type="submit" class="apisubmit" />-->
  ...
  <div class="clearfix"></div>
			...
			<div id="popup_domination_form_submit">
				<p class="submit">
					<input class="savecamp save-btn apisubmit" type="submit" name="submit" value="Save Changes" />										
				</p>
				</form>				
     ...
     <script type="text/javascript">
     	var popup_domination_url = '<?php echo $this->plugin_url ?>',<?php if(isset($apidata['provider']) && !empty($apidata['provider'])){ echo 'provider = "'.$apidata['provider'].'",';} ?> website_url = '<?php echo $this->site_url ?>', numfields = '<?php echo $number; ?>';
     </script>
</body>
</html>