                    ...
                    <table class="table table-hover table-striped">
                    	<thead>
							<tr>
								...
								<th data-sort-field="orders.create_ts">Date</th>
								<th>Actions</th>
							</tr>
						</thead>
						<tbody>
							...
							<tr>
								...
								<td>
									<a href="/<?php echo STORE_ADMIN_URL_PREFIX;?>/orders/order/<?php echo $order->id;?>" title="View" class="btn btn-action btn-success">
