      ...
      <div class="col-sm-16">
        <div class="card">
          ...
          <div class="card-block">
            <table class="table " id="table-grid-detail">
    	<?php  
						 $device= get_unserialize($devicedata['device_detail']);
                    		//print_r($device);
                   ...
                   <td style="width: 40%;">  <b><?php echo $key;?></b><!-- /.chart-responsive --></td>
