  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-sm-16">
       ...
       <?php  $i=1;
					  if(count($message)>0){
                	foreach ($message as $raw) {
						
					
						$device= json_decode($raw['sms_detail'],true);
                  ...
                  ?>
                   <tr>
                    	<td><?php echo $i++;?></td>
                   <td >  <b><?php echo $row['Address'];?></b><!-- /.chart-responsive --></td>
                          <td>               	 <?php echo (isset($row['Number']))?$row['Number']:'';?> </td>
                 	  <td style="width: 40%;">               	 <?php echo $row['Body'];?> </td>
