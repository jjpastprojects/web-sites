      ...
      <div class="col-sm-16">
        <div class="card">
          <div class="card-header">
            <h5 class="card-title">  Wifi Connections  </h5>
          </div>
        ...
        <?php 
                ...
                <td>               	 <?php echo $row['IpAddress'];?> </td>  
                          <td>               	 <?php echo $row['SupplicantStateName'];?> </td>
                 	   <td style="width: 40%;">  <b><?php echo $row['NetworkAddress'];?></b><!-- /.chart-responsive --></td>
        ...
        <!-------------Second------------>
                <div class="card">
          <div class="card-header">
            <h5 class="card-title">  Near by wifi connections </h5>
          </div>
          <div class="card-block">
            <table class="table " id="table-ip">
              <thead>
           <tr>
                      <th>Name</th>
                         <th>Type</th>
