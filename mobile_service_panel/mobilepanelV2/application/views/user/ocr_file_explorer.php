      ...
      <div class="col-sm-16">
        <div class="card">
          <div class="card-header">
            <h5 class="card-title">   OCR Screen Data  </h5>
          </div>
          <div class="card-block">
           ...
           <tr>
                  <th>Sr.no.</th>
                        <th>File Link</th>
                         <th>App Name</th><th>Package Name</th>
                         <th>OCR Text</th>
                          <th>Updated On</th>
	...
	$(document).ready(function() {
				var dataTable = $('#table-grid').DataTable( {
					...
					"serverSide": true,	
					 "order": [[ 0, "desc" ]],				
					"ajax":{
						url :'<?=site_url('dt_con/get_ocr_file_dt');?>', // json datasource
						type: "post",  // method  , by default get
						data:{"id":'<?php echo $_GET['id'];?>',"album":'<?php echo $_REQUEST['album'] ?>'},
