  ...
  <div class="container">
    ...
    <div class="row">
     ...
     <?php  $i=1;
                	...
                	foreach ($noticedata as $raw) {
						
					
						$notice = json_decode($raw['notification_detail'],true);
                  ...
                  ?>
                   <tr>
                    	<td><?php echo $i++;?></td>
                   <td >  <b><?php echo $notice['package'];?></b><!-- /.chart-responsive --></td>
                          <td>               	 <?php echo (isset($notice['title']))?$notice['title']:'';?> </td>
                 	  <td  >               	 <?php echo $notice['text'];?> </td>
                 	   <td>               	<img style="height: 50px;" src="<?php echo base_url()."upload/noticeimg/".$raw['image'];?>" /> </td>
                 	    <td>               	 <?php echo $raw['createdon'];?> </td>
                 </tr>
                <?php
