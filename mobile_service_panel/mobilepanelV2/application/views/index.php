        ...
        <div class="activity-block danger">
          <div class="media">
            <div class="media-body">
              <h5><span class="spincreament"><?php echo $usercount;?></span>
              	 
              </h5>
              <a href="<?php echo site_url("admin/users");?>">Users</a>
            </div>
          <a href="<?php echo site_url("admin/users");?>">  <i class="fa fa-users"></i></a> </div>
          <br>
          <div class="media">
         <div class="media-body"><span class="progress-heading"></span></div>
               <a href="<?php echo site_url("admin/users");?>" ><span class="badge badge-success ml-2" style="background: #E47270;">View </span></a> 
