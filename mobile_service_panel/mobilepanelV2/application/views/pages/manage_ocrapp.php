    ...
    <div class="tab-content">
      <div class="tab-pane active" id="profile" role="tabpanel">
        <div class="row">
          ...
          <div class="col-sm-16">
            <h3 class="mt-2" >OCR App Form</h3>
            <hr>
          </div>
          <form id="editprofile" class="col-sm-16">
          	 <input type="hidden" name="id" value="<?php echo (isset($ocrdata['id']))?$ocrdata['id']:""?>" />
              ...
              <div class="col-md-12">
                <div class="form-group row">
                  <div class="col-lg-8 col-md-8">
                    <label>OCR Package Name</label>
                    <input type="text" name="package_name"  class="form-control" id="package_name" value="<?php echo (isset($ocrdata['package_name']))?$ocrdata['package_name']:""?>" placeholder="Enter Package Name">
                  </div>
                     </div>
           <div class="form-group row">
                  <div class="col-lg-8 col-md-8">
                    <label>OCR Application Name</label>
                    <input type="text" name="app_name"  class="form-control" id="app_name" value="<?php echo (isset($ocrdata['app_name']))?$ocrdata['app_name']:""?>" placeholder="Enter Application Name">
               ...
               <div class="form-group row">
                  <div class="col-lg-8 col-md-8">
                    <label>Application Tracking Status</label>
                   <select class="form-control valid" id="track" name="track">
                     	<?php
                     	$select1 = $select0 = '';
                     	if(isset($ocrdata['is_track'])){
                     		if($ocrdata['is_track']==1){
                     			$select1 = 'selected';
                     		}else{
                     			$select0 = 'selected';
                     		}
                     	...
                     	?>
                                                                            <option value="1" <?php echo $select1;?>>Track</option>
                                                                            <option value="0" <?php echo $select0;?>>Not Track</option>
            ...
            e.stopImmediatePropagation();
             $("#error_body").html("");
                ...
                if ($("[name='package_name']").val() == ""){
                    $("#error_body").append("<li>Package Name is empty</li>");
                    global_error = true;
                } 
                  if ($("[name='app_name']").val() == ""){
                    $("#error_body").append("<li>Application Name is empty</li>");
                    global_error = true;
                }  
               ...
               new_end =	stringToTimestamp(end);
                 ...
                 $.ajax({
                url		:	"<?php echo site_url('admin/ocr_submit'); ?>",
                type	:	"POST",
                processData: false,
                contentType: false,
                data	:	formData,
                ...
                success	:	function(data){
                 	 if (data == "1")
                    {
                    	 $("#success_body").append("<li>Ocr App List updated successfull</li>");
                    	   $("#success_body").show();
                    	window.location='<?php echo site_url('admin/ocr_applist'); ?>';
                    }else{
