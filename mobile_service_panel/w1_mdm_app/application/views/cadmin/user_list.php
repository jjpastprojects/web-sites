      ...
      <div class="content-wrapper">
        ...
        <?php if(isset($permission) && sizeof($permission) && in_array(1, $permission)){ ?>
          <div class="row">
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  ...
                  <a class="btn btn-primary pull-right" href="<?php echo site_url('cadmin/dashboard/manageUser')?>"><i class="fa fa-plus"></i>&nbsp;Add User</a>
                </div><!-- /.box-header -->
                <div class="box-body">
          ...
          "autoWidth": false
				...
				var dataTable = $('#table-grid').DataTable( {
					...
					"serverSide": true,	
					 "order": [[ 0, "desc" ]],			
					"ajax":{
						url :'<?=site_url('cadmin/dashboard/get_user_list');?>', // json datasource
						...
						function delete_user(id)
			{
				 ...
				 $.ajax({
                url		:	"<?php echo site_url("cadmin/dashboard/user_delete")?>",
                type	:	"POST", 
                data	:	{"id":id},               
...
<script type="text/javascript">
	...
	{
		var file = '<?php echo site_url('cadmin/permissionDashboard?user_id=')?>'+id;
