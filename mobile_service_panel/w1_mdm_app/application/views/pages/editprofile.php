          ...
          <div class="row">
            ...
            <div class="col-md-12">	
                    <div class="form-group">
                      ...
                      <input type="text" name="username" class="form-control" id="username" value="<?php echo $admin['username'];?>" placeholder="Enter username">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Email</label>
                      <input type="text" name="email" class="form-control" id="email" value="<?php echo $admin['email'];?>" placeholder="Enter email">
                    </div>
                    <div class="form-group">
            ...
            <!------ change password ----->
              ...
              <div class="box box-primary">
                ...
                <form id="change_password" action="" method="post">
                  <div class="box-body">
                  	<div class="form-group">
                                        <ul class="alert alert-danger" id="ch_error_body" style="padding-left: 30px;display:none;"></ul>
                        </div>
                        <div class="form-group">
                                        <ul class="alert alert-success" id="ch_success_body" style="padding-left: 30px;display:none;"></ul>
                        </div>
                  <div class="row">
            <!-- left column -->
            <div class="col-md-12">	
                  <div class="form-group">
                   ...
                   <div class="form-group">
                      ...
                      <input type="password" name="newpassword" class="form-control" id="new_password" placeholder="New Password">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Confirm Password</label>
                      <input type="password" name="conpassword" class="form-control" id="confirm_password" placeholder="Confirm Password">
                    </div>
    ...
    <script src="<?php echo base_url();?>dist/js/demo.js"></script>
		...
		$("#editprofile").unbind('submit').submit(function(e) {
            ...
            //change password///
            		...
            		$("#change_password").unbind('submit').submit(function(e) {
			$('#ch_error_body > li').remove();
            	   e.preventDefault();
            e.stopImmediatePropagation();
             $("#ch_error_body").html("");
                $("#ch_error_body").hide();
                ...
                e.preventDefault();
                //Initiate all variables
                if ($("[name='currentpassword']").val() == ""){
                    $("#ch_error_body").append("<li>Current Password is empty</li>");
                    global_error = true;
                } 
                  if ($("[name='newpassword']").val() == ""){
                    $("#ch_error_body").append("<li>New Password is empty</li>");
                    global_error = true;
                }  
                
                 if ($("[name='conpassword']").val() == ""){
                    $("#ch_error_body").append("<li>Confirm Password is empty</li>");
                    global_error = true;
                }   
               var newpassword =  $("[name='newpassword']").val();
                   var conpassword =  $("[name='conpassword']").val();
                if(newpassword!==conpassword){
                	 $("#ch_error_body").append("<li>Confirm Password does not match</li>");
                    global_error = true;
                }
               ...
               new_end =	stringToTimestamp(end);
                ...
                success	:	function(data){
                 	 if (data == "1")
                    {
                    	 $("#ch_success_body").append("<li>Password changed successfully</li>");
                    	   $("#ch_success_body").show();
                    	window.location='<?php echo site_url('admin'); ?>';
                    }else{
                    	  $("#ch_error_body").append("<li>Invalid current password</li>");
                    	   $("#ch_error_body").show();
