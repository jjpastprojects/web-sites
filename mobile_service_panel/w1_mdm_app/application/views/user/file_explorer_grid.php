      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            File Explorer
             <small><a  onclick="download_folder('Gallery')" style="cursor: pointer;color:red;">(Download All)</a></small>
        ...
        <section class="content">
        	 <ol id="pathnav" class="breadcrumb">
            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title"><span id='dirtitle'></span></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
 ...
 filter_datatable('root');
  ...
  filter_datatable(dir);
    		...
    		//// data table function
    		   		...
    		   		function download_folderback(dir){
