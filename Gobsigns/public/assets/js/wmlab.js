...
+function ($) { "use strict";
  ...
  // ==================
$(document).ready(function(){
  $("#agency_range_target").slider();
  $("#agency_range_target").on("slide", function(slideEvt) {
    $("#agency_range_target_val").text(slideEvt.value);
  });

  $("#print_quantity").slider();
  $("#print_quantity").on("slide", function(slideEvt) {
    $("#print_quantity_val").text(slideEvt.value);
  });
})